...
public class ListadoInventario extends javax.swing.JFrame {

    private InventarioNegocio inventarioNegocio = new InventarioNegocio();
    ...
    public void listarEmpleado(){
        inventarioNegocio.listarInventario(tblInventario);
    }
    
    public void idMax(){
        txtID.setText(inventarioNegocio.getMaxID() + "");
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Listado Del Inventario\n", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 14))); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtfechaCompra, javax.swing.GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE)
    ...
    if(txtNombre.getText().isEmpty() || txtfechaCompra.getText().isEmpty() || txtProvedor.getText().isEmpty() || txtCantidad.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Porfavor Llene Todos Los Campos");
    }else{
            Inventario inventario = new Inventario();
            inventario.setNombre(txtNombre.getText());
            inventario.setFechaCompra(txtfechaCompra.getText());
            inventario.setProvedor(txtProvedor.getText());
            inventario.setCantidad(txtCantidad.getText());
            
            String mensaje = inventarioNegocio.agregarInventario(inventario);
    ...
    if(txtNombre.getText().isEmpty() || txtfechaCompra.getText().isEmpty() || txtProvedor.getText().isEmpty() || txtCantidad.getText().isEmpty()){
            ...
            Inventario inventario = new Inventario();
            inventario.setIdInventario(Integer.parseInt(txtID.getText()));
            inventario.setNombre(txtNombre.getText());
            inventario.setFechaCompra(txtfechaCompra.getText());
            inventario.setProvedor(txtProvedor.getText());
            inventario.setCantidad(txtCantidad.getText());
            
            String mensaje = inventarioNegocio.editarInventario(inventario);
            JOptionPane.showMessageDialog(null, mensaje);
            limpiar();
            listarEmpleado();
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
     ...
     if(txtNombre.getText().isEmpty() || txtfechaCompra.getText().isEmpty() || txtProvedor.getText().isEmpty() || txtCantidad.getText().isEmpty()){
            ...
            String mensaje = inventarioNegocio.eliminarInventario(Integer.parseInt(txtID.getText()));
            JOptionPane.showMessageDialog(null, mensaje);
            limpiar();
            listarEmpleado();
        }
    ...
    private void tblInventarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblInventarioMouseClicked
        ...
        txtID.setText(tblInventario.getValueAt(seleccion, 0) + "");
        txtNombre.setText(tblInventario.getValueAt(seleccion, 1) + "");
        txtfechaCompra.setText(tblInventario.getValueAt(seleccion, 2) + "");
        txtProvedor.setText(tblInventario.getValueAt(seleccion, 3) + "");
        txtCantidad.setText(tblInventario.getValueAt(seleccion, 4) + "");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListadoInventario().setVisible(true);
            }
        });
    }
