...
public class ListadoEmpleado extends javax.swing.JFrame {
    ...
    public void listarEmpleado(){
        empleadoNegocio.listarEmpleado(tblEmpleado);
    }
    
    public void idMax(){
        txtID.setText(empleadoNegocio.getMaxID() + "");
    }
    ...
    if(txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtTelefono.getText().isEmpty()){
            ...
            String mensaje = empleadoNegocio.agregarEmpleado(empleado);
    ...
    if(txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtTelefono.getText().isEmpty()){
            ...
            String mensaje = empleadoNegocio.editarEmpleado(empleado);
            JOptionPane.showMessageDialog(null, mensaje);
            limpiar();
            listarEmpleado();
        }
    ...
    if(txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtTelefono.getText().isEmpty()){
            ...
            String mensaje = empleadoNegocio.eliminarEmpleado(Integer.parseInt(txtID.getText()));
            JOptionPane.showMessageDialog(null, mensaje);
            limpiar();
            listarEmpleado();
        }
